...
$sliderpro_properties_help = array('width' => __('The total width of the slider. 
									...
									'jwplayer_path' => __('Indicate the path to the folder that contains the JW Player source files.', 'slider_pro') . '<br/><br/><b>'. 
...
$sliderpro_slider_sidebar_categories = array('publish' => __('Publish', 'slider_pro'),
											 ...
											 'image_resizing' => __('Image Resizing', 'slider_pro'),
